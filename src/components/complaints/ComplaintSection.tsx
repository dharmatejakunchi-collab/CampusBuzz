...
export const ComplaintSection: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      {/* Top Banner */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-rose-950 via-slate-900 to-amber-950 p-6 sm:p-8 text-white shadow-xl border border-rose-900/50">
        <div className="relative z-10 max-w-3xl space-y-3">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-rose-500/20 text-rose-300 border border-rose-500/40 text-xs font-black tracking-wider uppercase">
          ...
          <div className="pt-2 flex flex-wrap items-center gap-3">
            <button
              ...
              className="px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white font-extrabold text-xs rounded-xl shadow-lg shadow-rose-600/30 flex items-center space-x-1.5 active:scale-95 transition-all"
            >
            ...
            {isAdmin && (
              <span className="px-3 py-1 bg-red-950/80 border border-red-500/40 text-red-300 rounded-xl text-xs font-bold flex items-center space-x-1">
        ...
        <div className="absolute right-0 top-0 bottom-0 w-1/3 bg-gradient-to-l from-rose-500/20 to-transparent pointer-events-none" />
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <select
          ...
          className="px-3 py-1.5 text-xs font-bold rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 self-end sm:self-auto"
        >
      ...
      {loading ? (
        ...
        <div className="text-center py-16 px-4 bg-white dark:bg-slate-800/50 rounded-3xl border border-dashed border-slate-300 dark:border-slate-700">
          <EyeOff className="w-12 h-12 text-slate-400 mx-auto mb-2" />
          ...
          {filteredComplaints.map((item) => {
            ...
            return (
              <div
                ...
                className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 p-5 sm:p-6 shadow-sm hover:shadow-md transition-all space-y-4"
              >
