...
export const EventCalendarView: React.FC<EventCalendarViewProps> = ({ initialSelectedEventId }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      {/* Top Banner */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-950 via-slate-900 to-cyan-950 p-6 sm:p-8 text-white shadow-xl border border-blue-900/50">
        <div className="relative z-10 max-w-3xl space-y-3">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-blue-500/20 text-blue-300 border border-blue-500/40 text-xs font-black tracking-wider uppercase">
          ...
          <div className="pt-2 flex flex-wrap items-center gap-3">
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-extrabold text-xs rounded-xl shadow-md flex items-center space-x-1.5 active:scale-95 transition-all"
            >
            ...
            {canManage && (
              <button
                ...
                className="px-4 py-2 bg-white text-slate-950 hover:bg-slate-100 font-extrabold text-xs rounded-xl shadow-md flex items-center space-x-1.5 active:scale-95 transition-all"
              >
            ...
            <button
              ...
              className={`px-3.5 py-1.5 rounded-xl text-xs font-bold shrink-0 transition-all ${
                selectedCategory === cat
                  ...
                  : 'bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700 hover:bg-blue-50'
              }`}
            >
          ...
          <div className="flex items-center space-x-1 bg-slate-100 dark:bg-slate-800 p-1 rounded-xl border border-slate-200 dark:border-slate-700 text-xs">
            <button
              ...
              className={`px-3 py-1 rounded-lg font-bold ${
                activeTab === 'calendar' ? 'bg-white dark:bg-slate-900 text-blue-600 shadow' : 'text-slate-500'
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1 rounded-lg font-bold flex items-center space-x-1 ${
                activeTab === 'requests' ? 'bg-white dark:bg-slate-900 text-blue-600 shadow' : 'text-slate-500'
              }`}
            >
              ...
              {filteredEvents.map((event) => {
                ...
                return (
                  <div
                    ...
                    className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-md hover:shadow-xl transition-all overflow-hidden flex flex-col justify-between"
                  >
                    ...
                    <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                      ...
                      {/* Date Pill Tag */}
                      <div className="absolute top-3 left-3 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-xl p-2 text-center shadow-lg border border-slate-200 dark:border-slate-700 min-w-[54px]">
                      ...
                      <div className="absolute top-3 right-3">
                        <span className="px-2.5 py-1 rounded-lg text-xs font-black bg-blue-600 text-white shadow">
                          {event.category}
                        </span>
                      </div>
                      ...
                      <div className="absolute bottom-2.5 left-3 right-3 text-white text-xs flex items-center justify-between">
                        ...
                        {event.linkedAnnouncementId && (
                          <span className="text-[10px] bg-purple-600/80 px-2 py-0.5 rounded font-bold">
                            Linked Notice
                          </span>
                        )}
                      </div>
